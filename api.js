...
const mongourl = "mongodb+srv://sunny:sunny123@cluster0.414fv.mongodb.net/foodfly?retryWrites=true&w=majority";
...
//health Check
app.get('/',(req,res) => {
    res.send("Health Ok you can proceed");
});
